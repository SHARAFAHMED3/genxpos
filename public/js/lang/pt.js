LANG = {
    ...
    'name_already_exists' : 'Já existe um produto com este nome',
    ...
    'last_60_days': 'ltimos 60 Dias',
    'last_90_days': 'ltimos 90 Dias',
    'this_month': 'Este Mês',
    ...
    'name_already_exists' : 'Produto com este nome já existe',
    // AI Assistance translations
    'use_ai': 'Usar IA',
    'image_added_successfully': 'Imagem adicionada com sucesso',
    'fill_required_fields': 'Por favor, preencha os campos obrigatórios antes de usar IA',
    'generating_description': 'Gerando descrição do produto...',
    'generating_image': 'Gerando imagem do produto...',
    'processing': 'Processando...',
    'use_description': 'Usar Descrição',
    'use_image': 'Usar Imagem',
    'submit': 'Enviar',
    'fill_name_brand_for_image': 'Por favor, preencha o Nome do Produto e a Marca antes de gerar a imagem.',
    'fill_name_brand_unit_for_ai': 'Por favor, preencha o Nome do Produto, Marca e Unidade antes de usar IA.',
    'something_went_wrong_try_again': 'Algo deu errado, por favor tente novamente',
    'invoice_number_already_exists': 'Número da fatura já existe',
    'tax_number_already_exists' : 'Este número de imposto já existe',
    'missing_skus' : 'SKUs ausentes',
};