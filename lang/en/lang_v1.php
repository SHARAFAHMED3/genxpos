...
return [
    ...
    'installment_plan_help' => 'Create a payment schedule for the remaining due amount. Down payment is the amount you pay now in the payment rows.',
    'down_payment' => 'Down payment',
    'installment' => 'Installment',
    'installment_count' => 'Installments',
    'installment_interval' => 'Every',
    'installment_interval_type' => 'Interval type',
    'first_installment_due_date' => 'First installment due date',
    'installment_first_due_help' => 'Set the first due date for the installment schedule.',
    ...
    'hide_selected_product_image' => 'Hide selected product image (POS cart)',
    ...
    'enable_batch_pricing' => 'Enable Batch-based Pricing',
    'tooltip_enable_batch_pricing' => 'Allow a single product to hold multiple purchase batches with independent cost, selling price and stock. Each purchase creates a new batch; the POS asks the cashier which batch to sell when more than one exists.',
    'batch_details' => 'Batch Details',
    'batch_details_multi_batch_only' => 'Multi-batch products only',
    'batch_details_multi_batch_only_help' => 'This list includes only products that have two or more batches at the same location (for example Batch 1 and Batch 2). Single-batch items are hidden so you can focus on price and stock across batches.',
    'batch_number' => 'Batch #',
    'selling_price_inc_tax' => 'Selling Price (Inc. Tax)',
    'select_batch' => 'Select Batch',
    'select_price_for_product' => 'Select Price for Product',
    'available_stock' => 'Available Stock',
    'new_batch' => 'New batch',
    'existing_batches' => 'Existing batches',
    'product_already_has_batches' => 'This product already has batches. Add as a new batch?',
    'add_as_new_batch' => 'New batch',
    'update_existing_batch' => 'No, update existing',
    ...
    'refill_batch_select_label' => 'Refill an existing batch',
    'refill_batch_help' => 'Adds quantity to the selected batch bucket (same label and POS price bucket).',
    'refill_selected_batch' => 'Refill selected batch',
    'qty_in' => 'Qty In',
    'qty_out' => 'Qty Out',
    ...
    'mode' => 'Mode',
    'already_exchanged' => 'Already Exchanged',
    ...
    'purchase' => 'Purchase',
    'cheque_no' => 'Cheque No.',
    'cheque_issue_date' => 'Cheque Issue/Release Date',
    'cheque_passing_date' => 'Cheque Passing Date',
    ...
    'no_limit_set' => 'No limit set (unlimited credit)',
    'current_default_limit' => 'Current Default Limit',
    'no_default_limit_set' => 'No default limit set (new customers will have unlimited credit)',
    'default_credit_limit_help' => 'This will be the default credit limit for all new customers. Leave blank for unlimited credit.',
    ...
    'minimum_selling_price_error' => 'Price cannot be below the minimum selling price.',
    ...
    'view_purchase_cost_price' => 'View Purchase Cost/Profit (Purchases)',
    'view_purchase_cost_price_tooltip' => 'Permission to view unit cost, taxes, profit margin and purchase totals on Add/Edit Purchase screens.',
    'created' => 'Created',
    'updated' => 'Updated',
    'deleted' => 'Deleted',
    'day' => 'Day',
    ...
    'bypass_minimum_selling_price' => 'Allow selling below minimum selling price',
    ...
    'add_claim' => 'Add Claim',
    'claim_already_exists' => 'An open claim already exists for this item.',
    'no_warranty_for_line' => 'No warranty found for this item.',
    'status' => 'Status',
    'update_status' => 'Update Status',
    'invalid_status_change' => 'Invalid status change.',
    'supplier_required' => 'Supplier is required for this status.',
    'problem' => 'Problem',
    'notes' => 'Notes',
    'note' => 'Note',
    'timeline' => 'Timeline',
    ...
    'warranty_exp_date' => 'Warranty Expiry Date',
    ...
    'damages' => 'Damages',
    'recent_damages' => 'Recent Damages',
    'reason' => 'Reason',
    'unknown' => 'Unknown',
    'add_damage' => 'Add Damage',
    'damages_list' => 'List Damages',
    'all_damages' => 'All Damages',
    'added_by' => 'Added By',
