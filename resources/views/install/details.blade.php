                ...
                <div class="col-md-4">
                  ...
                  @if($activation_key)
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="password" name="MAC_LICENCE_CODE"  class="form-control" id="activation_licence_code">
                      </div>
                    </div>
                  @endif
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="db_host" name="DB_HOST"  placeholder="localhost / 127.0.0.1">
                    </div>
                  </div>
