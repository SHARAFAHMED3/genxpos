...
<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_7_label', __('lang_v1.custom_payment', ['number' => 7])) !!}
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[purchase_shipping][is_custom_field_1_required]" value="1" @if(!empty($custom_labels['purchase_shipping']['is_custom_field_1_required']) && $custom_labels['purchase_shipping']['is_custom_field_1_required']==1) checked @endif> @lang('lang_v1.is_required')</label>
                </div>
            </div>
        </div>
    </div>
