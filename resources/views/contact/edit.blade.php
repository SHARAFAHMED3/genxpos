        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::text('credit_limit', $contact->credit_limit != null ? @num_format($contact->credit_limit) : null, ['class' => 'form-control input_number', 'id' => 'credit_limit_input']) !!}
              </div>
              <div class="credit-limit-display" style="margin-top: 8px; padding: 8px 12px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 4px; font-size: 13px; color: #495057;">
                  ...
                  <span class="credit-limit-text">
                      @if($contact->credit_limit != null)
                          @lang('lang_v1.current_limit'): <strong>{{ @num_format($contact->credit_limit) }}</strong>
                      @else
