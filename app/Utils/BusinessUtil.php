...
class BusinessUtil extends Util
{
    ...
    public function createNewBusiness($business_details)
    {
        ...
        //Add POS shortcuts
        $business_details['keyboard_shortcuts'] = '{"pos":{"pay_n_ckeckout":"shift+p","draft":"shift+d","cancel":"shift+c","edit_discount":"shift+i","edit_order_tax":"shift+t","add_payment_row":"shift+r","finalize_payment":"shift+f","recent_product_quantity":"f2","add_new_product":"f4"}}';
    ...
    {
        return ['disable_pay_checkout' => 0, 'disable_draft' => 0, 'disable_express_checkout' => 0, 'hide_product_suggestion' => 0, 'hide_recent_trans' => 0, 'disable_discount' => 0, 'disable_order_tax' => 0, 'is_pos_subtotal_editable' => 0, 'enable_msp' => 0, 'hide_selected_product_image' => 0];
    }
